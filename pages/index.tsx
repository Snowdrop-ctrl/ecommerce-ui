    ...
    <div>
      <Head>
        ...
        <header>
            <div className="">
                <nav className="menu">
                    <a href="#"><svg width="34" height="23" viewBox="0 0 34 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section className="hero">
            <div className='hero-content'>
                <p>With an outstanding style, only for you</p>
                <p>Exclusively designed for you</p>
            </div>
